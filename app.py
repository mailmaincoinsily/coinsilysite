...
def calculate():
    ...
    liquidity_amount = float(request.form['liquidityAmount'])  # Get liquidity amount from the form

    data = calculate_arbitrage(exchange1, exchange2, liquidity_amount)  # Pass the liquidity_amount
